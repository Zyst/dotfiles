...
- 🟡 **Quick-nav marks (harpoon)** — **queued next after file explorer (2026-05-31).** User pre-prioritized this slot. See inventory row for candidate (harpoon.nvim 2.x).
- 🟡 **Oil.nvim paradigm evaluation** — **queued at end after traditional file explorer + harpoon land (2026-05-31).** User wants to evaluate the "edit directory as a buffer" paradigm separately rather than as an alternative-to-sidebar. May land as a complement to the sidebar pick (wincent's dual-tool pattern), not a replacement. See file-explorer inventory row for the oil candidate.
